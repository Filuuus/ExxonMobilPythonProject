...
% ── Variables del Proyecto (Edítalas aquí) ─────────────────────────────────────
\newcommand{\materia}{Python Programming}
\newcommand{\profesor}{Dr. Fares Fraij}
\newcommand{\alumnoA}{Juan Pablo Martin Hurtado jpm5539}
\newcommand{\alumnoB}{Esteban Daniel Marcellan Medina edm3226}
\newcommand{\alumnoC}{Santiago Basaldua Ramirez sb74887}
...
\newcommand{\showfooter}{%
  \setbeamertemplate{footline}{
    ...
    {\scriptsize\color{utgray}
      \currentspeaker
      \quad\textbar\quad \resizebox{!}{1ex}{\materia} \quad\textbar\quad UT Austin
    }
    \hfill
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \fill[utred] (current page.north west) rectangle ++(0.08\paperwidth, -\paperheight);
    \fill[utlightblue] ([xshift=0.08\paperwidth]current page.north west)
      rectangle ++(0.01\paperwidth, -\paperheight);
  \end{tikzpicture}
  ...
  \begin{columns}[T]
    ...
    \column{0.88\textwidth}
      ...
      \begin{tabular}{p{0.12\textwidth} p{0.75\textwidth}}
        {\scriptsize\color{utgray} Course}    & {\scriptsize\color{textdark} \materia}    \\[2pt]
        {\scriptsize\color{utgray} Professor} & {\scriptsize\color{textdark} \profesor}   \\[4pt]
        {\scriptsize\color{utgray} Team}      & {\scriptsize\color{textdark} \alumnoA}    \\
                                              & {\scriptsize\color{textdark} \alumnoB}    \\
                                              & {\scriptsize\color{textdark} \alumnoC}    \\
      \end{tabular}
    ...
    \column{0.48\textwidth}
      ...
      \begin{itemize}\setlength\itemsep{7pt}
        ...
        \begin{itemize}
          ...
          \item {\scriptsize\texttt{sem 21 / total 280 / area1 80.5}}
        \end{itemize}
        \vspace{3pt}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \fill[utblue] (current page.south west) rectangle ++(\paperwidth,{0.35\paperheight});
    \fill[utred]  (current page.south west) rectangle ++(\paperwidth,{0.04\paperheight});
    
    \node[anchor=south, text width=0.9\paperwidth, align=center] at ([yshift=0.06\paperheight]current page.south) {
      {\scriptsize\color{bgwhite} \alumnoA} \\[2pt]
      {\scriptsize\color{bgwhite} \alumnoB} \\[2pt]
      {\scriptsize\color{bgwhite} \alumnoC} \\[6pt]
      {\scriptsize\color{bgwhite} \materia \quad\textbar\quad UT Austin}
    };
  \end{tikzpicture}
